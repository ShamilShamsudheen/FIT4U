                            ...
                            <div className="hidden sm:ml-6 sm:block items-center ml-auto w-[100%] nav-items-div">
                                <div className="flex items-center space-x-center justify-center mt-5">
                                    ...
                                    <div className="flex items-center space-x-4 mt-5"> {/* Use space-x-4 to add spacing between links */}
                                        ...
                                        <Link to={logout ? "/trainerList":"#trainer"} className="text-gray-300 hover:text-white rounded-md px-3 py-2 hover:underline hover:border-red-500 hover:border-b hover:border-solid text-sm font-medium uppercase">trainer</Link>
                                        <Link to={logout ? "/blogs":"#blogs"} className="text-gray-300 hover:text-white rounded-md px-3 py-2 hover:underline hover:border-red-500 hover:border-b hover:border-solid text-sm font-medium uppercase">blog</Link>
                                        {logout && (
